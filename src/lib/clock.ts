 ...
 * (a button's onClick — see WordleGame/BoardQuestionCard), never from the render path
 * itself, so the impurity is harmless there; but the strict react-hooks/purity
