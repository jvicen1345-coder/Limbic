        ...
        <aside className="wellness-continuum-sidebar">
          <div className="wellness-goal-guide">
            ...
            <p style={{ fontSize: 11.5, color: "var(--color-neutral-600)", marginTop: 10 }}>
              These are general guidelines. A licensed physical therapist or certified strength coach can help you design a program
              specific to your needs and health history.
            </p>
          </div>
        </aside>
