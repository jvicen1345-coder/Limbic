...
CREATE TABLE "new_User" (
    ...
    "licenseFullName" TEXT,
    "licenseStatus" TEXT,
    "licenseSubmittedAt" DATETIME,
    "licenseVerifiedAt" DATETIME,
    "licenseAttestation" BOOLEAN NOT NULL DEFAULT false,
    "email" TEXT,
    "backupEmail" TEXT,
...
INSERT INTO "new_User" ("accountMigrated", "backupEmail", "backupEmailAddedAt", "bio", "boardsStreakDays", "calendarEventIds", "ceCategories", "certificationExpiry", "ceuDeadline", "clipsSeenIds", "createdAt", "email", "followedTopics", "gamesStreakDays", "graduationDate", "graduationTransitionShownAt", "hasOnboarded", "headline", "hiddenHomeWidgets", "homeGridSeenFingerprints", "id", "isGuest", "isPro", "isWellnessPlus", "lastBoardsActivityAt", "lastGamesActivityAt", "lastReadAt", "lastVisitedAt", "licenseEmail", "licenseExpiration", "licenseNumber", "licenseState", "migrationDate", "migrationEmailSentAt", "name", "nexusOptIn", "npteExamDate", "practiceStartDate", "practiceState", "reminderPreferences", "rotationEndDate", "rotationStartDate", "specialty", "streakDays", "stripeCustomerId", "stripeSubscriptionId", "studentTier", "wellnessArticleIds", "wellnessOpenedIds", "wellnessPlusInterval", "wellnessPlusSubscriptionId", "wellnessVideoIds") SELECT "accountMigrated", "backupEmail", "backupEmailAddedAt", "bio", "boardsStreakDays", "calendarEventIds", "ceCategories", "certificationExpiry", "ceuDeadline", "clipsSeenIds", "createdAt", "email", "followedTopics", "gamesStreakDays", "graduationDate", "graduationTransitionShownAt", "hasOnboarded", "headline", "hiddenHomeWidgets", "homeGridSeenFingerprints", "id", "isGuest", "isPro", "isWellnessPlus", "lastBoardsActivityAt", "lastGamesActivityAt", "lastReadAt", "lastVisitedAt", "licenseEmail", "licenseExpiration", "licenseNumber", "licenseState", "migrationDate", "migrationEmailSentAt", "name", "nexusOptIn", "npteExamDate", "practiceStartDate", "practiceState", "reminderPreferences", "rotationEndDate", "rotationStartDate", "specialty", "streakDays", "stripeCustomerId", "stripeSubscriptionId", "studentTier", "wellnessArticleIds", "wellnessOpenedIds", "wellnessPlusInterval", "wellnessPlusSubscriptionId", "wellnessVideoIds" FROM "User";
DROP TABLE "User";
