...
CREATE TABLE "GameActivity" (
    ...
    CONSTRAINT "GameActivity_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO "new_User" ("bio", "boardsStreakDays", "calendarEventIds", "ceCategories", "certificationExpiry", "ceuDeadline", "clipsSeenIds", "createdAt", "email", "followedTopics", "graduationDate", "hasOnboarded", "headline", "hiddenHomeWidgets", "id", "isGuest", "isPro", "lastBoardsActivityAt", "lastReadAt", "lastVisitedAt", "licenseEmail", "licenseExpiration", "licenseNumber", "licenseState", "name", "nexusOptIn", "npteExamDate", "practiceStartDate", "practiceState", "reminderPreferences", "rotationEndDate", "rotationStartDate", "specialty", "streakDays", "studentTier", "wellnessArticleIds", "wellnessOpenedIds", "wellnessVideoIds") SELECT "bio", "boardsStreakDays", "calendarEventIds", "ceCategories", "certificationExpiry", "ceuDeadline", "clipsSeenIds", "createdAt", "email", "followedTopics", "graduationDate", "hasOnboarded", "headline", "hiddenHomeWidgets", "id", "isGuest", "isPro", "lastBoardsActivityAt", "lastReadAt", "lastVisitedAt", "licenseEmail", "licenseExpiration", "licenseNumber", "licenseState", "name", "nexusOptIn", "npteExamDate", "practiceStartDate", "practiceState", "reminderPreferences", "rotationEndDate", "rotationStartDate", "specialty", "streakDays", "studentTier", "wellnessArticleIds", "wellnessOpenedIds", "wellnessVideoIds" FROM "User";
DROP TABLE "User";
...
-- CreateIndex
CREATE UNIQUE INDEX "GameActivity_userId_dateKey_key" ON "GameActivity"("userId", "dateKey");
