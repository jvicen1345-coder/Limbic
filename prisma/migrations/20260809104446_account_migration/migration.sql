...
INSERT INTO "new_User" ("bio", "boardsStreakDays", "calendarEventIds", "ceCategories", "certificationExpiry", "ceuDeadline", "clipsSeenIds", "createdAt", "email", "followedTopics", "gamesStreakDays", "graduationDate", "hasOnboarded", "headline", "hiddenHomeWidgets", "homeGridSeenFingerprints", "id", "isGuest", "isPro", "lastBoardsActivityAt", "lastGamesActivityAt", "lastReadAt", "lastVisitedAt", "licenseEmail", "licenseExpiration", "licenseNumber", "licenseState", "name", "nexusOptIn", "npteExamDate", "practiceStartDate", "practiceState", "reminderPreferences", "rotationEndDate", "rotationStartDate", "specialty", "streakDays", "stripeCustomerId", "stripeSubscriptionId", "studentTier", "wellnessArticleIds", "wellnessOpenedIds", "wellnessVideoIds") SELECT "bio", "boardsStreakDays", "calendarEventIds", "ceCategories", "certificationExpiry", "ceuDeadline", "clipsSeenIds", "createdAt", "email", "followedTopics", "gamesStreakDays", "graduationDate", "hasOnboarded", "headline", "hiddenHomeWidgets", "homeGridSeenFingerprints", "id", "isGuest", "isPro", "lastBoardsActivityAt", "lastGamesActivityAt", "lastReadAt", "lastVisitedAt", "licenseEmail", "licenseExpiration", "licenseNumber", "licenseState", "name", "nexusOptIn", "npteExamDate", "practiceStartDate", "practiceState", "reminderPreferences", "rotationEndDate", "rotationStartDate", "specialty", "streakDays", "stripeCustomerId", "stripeSubscriptionId", "studentTier", "wellnessArticleIds", "wellnessOpenedIds", "wellnessVideoIds" FROM "User";
DROP TABLE "User";
